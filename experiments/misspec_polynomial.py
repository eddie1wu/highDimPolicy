...
def main():
    ...
    cfg = load_config("configs/misspec_polynomial.toml")

    results = run_polynomial(cfg)

    run_dir = make_run_dir(Path("results"), tag="misspec_polynomial")
...
def run_polynomial(cfg, max_workers: int | None = None):
