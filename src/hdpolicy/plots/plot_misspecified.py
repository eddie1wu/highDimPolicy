...
def plot_welfare_misspecified(
        res: dict,
        interpolating_threshold: int,   # 75
        title: str = "Double Ascent in Welfare Maximization (Misspecification)"
):
    """
    ...
    true_feature_welfare = res["true_feature_welfare"]
    p_grid = res["p_grid"]
    ...
    ax.axhline(oracle_welfare, label = "Oracle welfare", color = "r", ls = "--")
    ax.axhline(true_feature_welfare, label = "Correctly specified", color = "C0", ls = "--")
